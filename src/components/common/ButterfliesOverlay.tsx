...
export const ButterfliesOverlay: React.FC<ButterfliesOverlayProps> = ({
  ...
  // 20 natural butterflies cleanly referencing high-quality cached assets (b1, b3, b4, b6)
  ...
  const butterflyConfigs = [
    ...
    { id: 'bf-2', base: 'b6', size: 50, duration: '26s', delay: '1.5s', pathClass: 'butterfly-path-2', glow: theme === 'intro' ? 'drop-shadow(0 0 12px rgba(229,197,120,0.75))' : 'drop-shadow(0 4px 10px rgba(157,78,221,0.35))' },
    ...
    { id: 'bf-7', base: 'b1', size: 48, duration: '28s', delay: '9.8s', pathClass: 'butterfly-path-7', glow: theme === 'intro' ? 'drop-shadow(0 0 12px rgba(229,197,120,0.7))' : 'drop-shadow(0 4px 10px rgba(82,23,130,0.3))' },
    ...
    { id: 'bf-13', base: 'b6', size: 46, duration: '23s', delay: '19s', pathClass: 'butterfly-path-13', glow: theme === 'intro' ? 'drop-shadow(0 0 11px rgba(229,197,120,0.7))' : 'drop-shadow(0 3px 8px rgba(82,23,130,0.3))' },
    ...
    { id: 'bf-17', base: 'b1', size: 44, duration: '24s', delay: '25s', pathClass: 'butterfly-path-1', glow: theme === 'intro' ? 'drop-shadow(0 0 10px rgba(212,175,55,0.65))' : 'drop-shadow(0 3px 8px rgba(82,23,130,0.3))' },
